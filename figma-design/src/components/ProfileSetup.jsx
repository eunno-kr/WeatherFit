...
export default function ProfileSetup({ profile, setProfile, cities, onStart }) {
  ...
  return (
    <main className="figma-shell min-h-screen px-5 py-8 text-ink">
      <section className="figma-content mx-auto max-w-[900px]">
        <div className="mb-4 flex items-center justify-between border border-ink bg-[#1A1A1A] px-3 py-2 text-xs text-[#FFFDF7]">
          ...
          <span className="hidden text-[#D8D0C2] sm:inline">Profile first flow</span>
        </div>
        <div className="border-b-2 border-ink pb-6">
          <div className="brand-wordmark text-[34px] sm:text-[44px]">
            WEATHER<span className="text-[#E8543B]">FIT</span>
          </div>
          <div className="mt-4 wf-label text-[#7C8B5A]">PROFILE SETUP</div>
          <h1 className="mt-3 max-w-[680px] text-3xl font-semibold leading-tight sm:text-4xl">
        ...
        <div className="wf-card mt-6 grid gap-5 p-5 sm:grid-cols-2 sm:p-6">
          <div>
