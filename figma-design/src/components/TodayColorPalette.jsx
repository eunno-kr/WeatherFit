...
const STEP1_QUESTIONS = [
  {
    ...
    hint: "밝은 자연광 아래 손목을 뒤집어서 확인하세요. 초록빛이면 웜톤, 파란·보라빛이면 쿨톤일 가능성이 높아요. 두 색이 섞여 보이면 더 가까운 쪽을 고르세요.",
    options: [{ label: "초록빛", value: "W" }, { label: "파란·보라빛", value: "C" }],
  },
  {
    q: "자연 피부에서 느껴지는 빛깔은?",
    hint: "화장을 지운 상태에서 햇빛이 드는 창가에서 확인하세요. 노란기·복숭아빛이 돌면 웜톤, 핑크빛·파란기가 살짝 돌면 쿨톤이에요. 잘 모르겠으면 가까운 사람에게 물어봐도 좋아요.",
    options: [{ label: "노란빛·황금빛·복숭아빛", value: "W" }, { label: "분홍빛·파란빛·붉은빛", value: "C" }],
  },
  {
    q: "더 잘 어울리는 금속 액세서리는?",
    hint: "직접 착용해봤을 때 피부가 더 화사하고 생기있어 보이는 쪽을 고르세요. 둘 다 없다면 상상해서 골라보세요. 골드가 잘 받으면 웜톤, 실버가 잘 받으면 쿨톤이에요.",
    options: [{ label: "골드(Gold) — 더 화사해 보임", value: "W" }, { label: "실버(Silver) — 더 화사해 보임", value: "C" }],
  },
  {
    q: "햇빛에 오래 노출되면 피부가 어떻게 되나요?",
    hint: "여름에 야외 활동 후 피부 변화를 떠올려보세요. 자연스럽게 황금빛으로 그을리면 웜톤, 금방 빨개지거나 타도 금방 돌아오거나 잘 타지 않으면 쿨톤이에요.",
    options: [{ label: "황금빛으로 자연스럽게 그을림", value: "W" }, { label: "쉽게 붉어지거나 잘 타지 않음", value: "C" }],
  },
  {
    q: "전체적인 피부 인상은?",
    hint: "자연광 아래에서 거울을 봤을 때 느낌이에요. '맑고 투명하다' '또렷하고 대비가 있다'면 밝음, '부드럽고 차분하다' '깊이 있고 풍성하다'면 깊음을 고르세요.",
    options: [
